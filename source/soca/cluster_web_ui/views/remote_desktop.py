...
if [[ "''' + base_os + '''" == "centos7" ]];
then
        curl -o /etc/yum.repos.d/CentOS-Base.repo https://soca-china-deployment.s3.cn-northwest-1.amazonaws.com.cn/scale-out-computing-on-aws/v2.6.0/CentOS-Base-china.repo
fi
